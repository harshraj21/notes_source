...
//        z=0.0;
        ...
        Toast.makeText(EceActivity.this,"Ece Branch",Toast.LENGTH_SHORT).show();
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Notes/ece");
...
//                    Toast.makeText(IseActivity.this,x,Toast.LENGTH_LONG).show();
                ...
                adapter = new NotesAdapter(EceActivity.this, images, names );
...
//             startActivity(j);
                switch (i) {
                    case 0:
                        Intent j = new Intent(EceActivity.this, thsemActivity.class);
                        j.putExtra("ctx","3");
                        startActivity(j);
                        break;
                    case 1:
                        Intent k = new Intent(EceActivity.this, fursemActivity.class);
                        k.putExtra("ctx","3");
                        startActivity(k);
                        break;
                    case 2:
                        Intent m = new Intent(EceActivity.this, fifsemActivity.class);
                        m.putExtra("ctx","3");
                        startActivity(m);
                        break;
                    case 3:
                        Intent n = new Intent(EceActivity.this, SixsemActivity.class);
                        n.putExtra("ctx","3");
                        startActivity(n);
                        break;
                    case 4:
                        Intent o = new Intent(EceActivity.this, SevsemActivity.class);
                        o.putExtra("ctx","3");
                        startActivity(o);
                        break;
                    case 5:
                        Intent p = new Intent(EceActivity.this, EighsemActivity.class);
                        p.putExtra("ctx","3");
                        startActivity(p);
                        break;
                }
...
//                Toast.makeText(EceActivity.this,"Ece Branch",Toast.LENGTH_SHORT).show();
            ...
            case R.id.acc:
                ...
                break;
            case R.id.fre:
                Intent k = new Intent(EceActivity.this, FresherActivity.class);
                startActivity(k);
                Toast.makeText(EceActivity.this,"Freshers",Toast.LENGTH_SHORT).show();
                break;
